...
import 'package:flutter_picker/photo_view/photo_view_scale_boundaries.dart';
import 'package:flutter_picker/photo_view/photo_view_scale_state.dart';
import 'package:flutter_picker/photo_view/photo_view_utils.dart';
...
class PhotoViewImageWrapper extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new _PhotoViewImageWrapperState(listener);
  }
}

class _PhotoViewImageWrapperState extends State<PhotoViewImageWrapper>
    with TickerProviderStateMixin {
  final StateListener _listener;

  _PhotoViewImageWrapperState(this._listener);
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    _listener.state(_position.dx-_positionBefore.dx);
  }
